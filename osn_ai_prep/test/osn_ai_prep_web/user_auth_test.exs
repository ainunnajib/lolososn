defmodule OsnAiPrepWeb.UserAuthTest do
  use OsnAiPrepWeb.ConnCase, async: true

  alias OsnAiPrep.Accounts
  alias OsnAiPrep.Accounts.Scope
  alias OsnAiPrepWeb.UserAuth

  import OsnAiPrep.AccountsFixtures

  @remember_me_cookie "_osn_ai_prep_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OsnAiPrepWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
